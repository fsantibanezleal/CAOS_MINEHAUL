...
| Scenarios | [scenarios/](scenarios/scenarios.md) | every variation axis, the seven validity gates, diversity signatures, the gallery |
| Guides | [guides/](guides/guides.md) | quickstart, custom policies, your own equipment/network, DispatchLab integration |
| Decisions | [adr/](adr/) | ADR-0001..0006: engine choice, numpy-only, event anchoring, name, single_lane_op, inventory coupling |

Visual index: the [12-seed gallery](../gallery/README.md) is the fastest way to see what the
generators produce.
